    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="groupModalLabel">Tambah Group Modul</h5>
            </div>
            <form action="<?= base_url('pengaturan/group_modul/simpan') ?>" id="groupForm" method="post">
                <input type="hidden" name="id" id="id">
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="modul" class="form-label">Nama Group Modul</label>
                        <input type="text" class="form-control" name="modul" id="modul" required>
                    </div>
                    <div class="mb-3">
...
$(document).ready(function() {
    ...
    $('#groupForm').on('submit', function(e) {
        ...
        var form = $(this);
        var id = $('#id').val();
        var url = id ? "<?= base_url('pengaturan/group_modul/update') ?>" :
            "<?= base_url('pengaturan/group_modul/simpan') ?>";
