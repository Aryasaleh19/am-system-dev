    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="labelModal">Tambah Tahun Angkatan</h5>
            </div>
            <form action="<?= base_url('kesiswaan/angkatan/simpan') ?>" id="formInput" method="post">
...
$(document).ready(function() {
    ...
    $('#formInput').on('submit', function(e) {
        ...
        var form = $(this);
        var id = $('#id').val();
        var url = id ? "<?= base_url('kesiswaan/angkatan/update') ?>" :
            "<?= base_url('kesiswaan/angkatan/save') ?>";
