    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="labelModal">Form Jabatan</h5>
            </div>
            <form action="<?= base_url('referensi/jabatan/simpan') ?>" id="formInput" method="post">
                <input type="hidden" name="id" id="id">
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="jabatan" class="form-label">Jabatan</label>
                        <input type="text" class="form-control" name="jabatan" id="jabatan" placeholder="Nama jabatan"
                            required>
                    </div>
                    <div class="mb-3">
...
$(document).ready(function() {
    ...
    $('#formInput').on('submit', function(e) {
        ...
        var form = $(this);
        var id = $('#id').val();
        var url = id ? "<?= base_url('referensi/jabatan/update') ?>" :
            "<?= base_url('referensi/jabatan/simpan') ?>";
