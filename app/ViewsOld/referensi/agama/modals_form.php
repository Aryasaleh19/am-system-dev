...
<div class="modal fade" id="groupModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('referensi/agama/simpan') ?>" id="formInput" method="post">
                <input type="hidden" name="id" id="id">
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="agama" class="form-label">Agama</label>
                        <input type="text" class="form-control" name="agama" id="agama" placeholder="Nama agama"
                            required>
                    </div>
                    <div class="mb-3">
...
$(document).ready(function() {
    ...
    $('#formInput').on('submit', function(e) {
        ...
        var form = $(this);
        var id = $('#id').val();
        var url = id ? "<?= base_url('referensi/agama/update') ?>" :
            "<?= base_url('referensi/agama/simpan') ?>";
