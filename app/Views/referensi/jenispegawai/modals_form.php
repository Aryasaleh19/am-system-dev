    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="labelModal">Tambah Jabatan</h5>
            </div>
            <form action="<?= base_url('referensi/jenispegawai/simpan') ?>" id="formInput" method="post">
                <input type="hidden" name="id" id="id">
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="jenis" class="form-label">Jenis Pegawai</label>
                        <input type="text" class="form-control" name="jenis" id="jenis" placeholder="Jenis Pegawai"
                            required>
                    </div>
                    <div class="mb-3">
...
$(document).ready(function() {
    ...
    $('#formInput').on('submit', function(e) {
        ...
        var form = $(this);
        var id = $('#id').val();
        var url = id ? "<?= base_url('referensi/jenispegawai/update') ?>" :
            "<?= base_url('referensi/jenispegawai/simpan') ?>";
